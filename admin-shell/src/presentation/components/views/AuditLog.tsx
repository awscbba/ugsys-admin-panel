...
import type { AuditLogFilters, PaginatedAuditLogs } from '../../../domain/repositories/AuditRepository';
...
type SortField = 'timestamp' | 'actorUserId' | 'targetService' | 'httpMethod' | 'responseStatus';
...
function FilterBar({ filters, onChange, onApply, onReset, isLoading }: FilterBarProps) {
  ...
  return (
    ...
    >
      ...
      >
        {/* From date */}
        <div>
          <label htmlFor="audit-from-date" style={labelStyle}>From date</label>
          <input
            id="audit-from-date"
            type="date"
        ...
        {/* To date */}
        <div>
          <label htmlFor="audit-to-date" style={labelStyle}>To date</label>
          <input
            id="audit-to-date"
            type="date"
        ...
        {/* Actor user ID */}
        <div>
          <label htmlFor="audit-actor" style={labelStyle}>Actor user ID</label>
          <input
            id="audit-actor"
            type="text"
        ...
        {/* Target service */}
        <div>
          <label htmlFor="audit-service" style={labelStyle}>Target service</label>
          <input
            id="audit-service"
            type="text"
        ...
        {/* HTTP method */}
        <div>
          <label htmlFor="audit-method" style={labelStyle}>HTTP method</label>
          <select
            id="audit-method"
...
export function AuditLog() {
  ...
  const [pendingFilters, setPendingFilters] = useState<AuditLogFilters>(EMPTY_FILTERS);
            ...
            <thead>
              <tr>
                ...
                <SortableHeader
                  ...
                  onSort={handleSort}
                />
                <th scope="col" style={{ ...thStyle, cursor: 'default' }}>Action</th>
                <SortableHeader
                  field="targetService"
                  ...
                  onSort={handleSort}
                />
                <th scope="col" style={{ ...thStyle, cursor: 'default' }}>Path</th>
                <SortableHeader
                  field="httpMethod"
                  label="Method"
                  sortField={sortField}
